...
model.fit_generator(train_generator, samples_per_epoch= len(train_data)*2, validation_data=validation_generator, nb_val_samples=len(validation_data), nb_epoch=3)
