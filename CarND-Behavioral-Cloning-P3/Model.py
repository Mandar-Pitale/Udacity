    ...
    while 1: # Loop forever so the generator never terminates
        ...
        for offset in range(0, num_samples, batch_size):
            ...
            for batch_sample in batch_samples:
                ...
                center_image_flipped = cv2.flip(center_image_RGB, 1)
...
model.fit_generator(train_generator, samples_per_epoch= len(train_data)*4, validation_data=validation_generator, nb_val_samples=len(validation_data)*4, nb_epoch=7)
